...
let clientId = 'client_id=da98a5b9961648f9bdfc57b8c3a9f365'
let clientSecret = 'client_secret=26d6e096289a4debbf2d16b97eb5e45a'

let datosBody = grantType + '&' + clientId + '&' + clientSecret

//3. EJECUTE EL CONSUMO A TRAVES DEL FECHT 
let peticion = {
    method: 'POST',
    headers: {
...
fetch(url, peticion)
    ...
    .then(function (respuesta) {
        ...
        let urlCanciones = "https://api.spotify.com/v1/artists/3OcvS8PzSGYMBvLdzY6g3e/top-tracks?market=US"
        ...
        fetch(urlCanciones, peticionCanciones)
            ...
            .then(function (respuesta) {
                ...
                console.log(respuesta.tracks[2].album.images[2])
                ...
                console.log(respuesta.tracks[3].album.images[3])
                ...
                console.log(respuesta.tracks[4].album.images[4])
                ...
                console.log(respuesta.tracks[5].album.images[5])
                ...
                console.log(respuesta.tracks[6].album.images[6])
                ...
                console.log(respuesta.tracks[7].album.images[7])
                ...
                imagen8.src=respuesta.tracks[7].album.images[0]
                ...
                console.log(respuesta.tracks[8].album.images[8])
                ...
                console.log(respuesta.tracks[9].album.images[9])
                ...
                let audio10=document.getElementById("audio9")
